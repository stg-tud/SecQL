...
../lib/aws-ecs-register-task-definition.sh i3ql-hospital-patient $CLIENT_REPO 0.25vcpu 0.5GB
../lib/aws-ecs-register-task-definition.sh i3ql-hospital-person $CLIENT_REPO 0.25vcpu 0.5GB
../lib/aws-ecs-register-task-definition.sh i3ql-hospital-knowledge $CLIENT_REPO 0.25vcpu 0.5GB
../lib/aws-ecs-register-task-definition.sh i3ql-hospital-client $CLIENT_REPO 0.25vcpu 0.5GB
